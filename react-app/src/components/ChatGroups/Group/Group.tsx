...
function Group (props: Params) {
	return (
		<div className={style.Group}>
			<NavLink to={props.goTo}  className={({ isActive }) =>
...
function AddGroup () {
	return (
		...
		<Group name='Add a Group' goTo='/about' imgURL={addSVG}/> {/* to change */}
		</div>);
}
...
Group.defaultProps = {
	name: "test",
	imageURL: "https://www.citypng.com/public/uploads/preview/hd-css3-round-logo-icon-transparent-png-11662224253zt2ubozvzc.png"
}
